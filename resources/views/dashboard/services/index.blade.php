            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-left">
                    <div class="d-flex justify-content-start gap-3">
                        ...
                        <a href="{{ route('admin.services.create') }}" class="btn-add"><i class="fas fa-plus me-2"></i>Thêm
                            dịch vụ</a>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="thumb-wrap position-relative d-inline-block">
                                        {{-- Ảnh chính --}}
                                        <img class="img-primary rounded-3 shadow" src="{{ $first }}"
                                            style="width:90px;height:90px;object-fit:cover"
                                            onerror="this.src='{{ asset("images/default-service.jpg") }}'" loading="lazy">

                                        {{-- Ảnh chi tiết (không phải main) --}}
                                        @if($second)
                                            <img class="img-secondary rounded-3" src="{{ $second }}"
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="{{ route('admin.services.destroy', $service->service_id) }}" method="POST"
                                            class="d-inline"
                                            onsubmit="return confirm('Xóa dịch vụ «{{ $service->service_name }}»?')">
                                            @csrf @method('DELETE')
            ...
            <div class="card-footer bg-white border-top">
                <div class="row align-items-center">
                    <div class="col-md-6 text-muted">
                        Hiển thị {{ $services->firstItem() }} đến {{ $services->lastItem() }} trong {{ $services->total() }}
                        dịch vụ
                    </div>
