...
@section('breadcrumb-child', 'Bài viết')
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="page-header">
        ...
        <div class="mt-4 flex flex-wrap gap-3">
          <a href="#"
            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl shadow-lg hover:from-blue-600 hover:to-blue-700 transform hover:scale-105 transition-all duration-200">
                ...
                <tr class="hover:bg-blue-100 hover:border-l-4 hover:border-blue-500 transition-colors duration-150 group">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center space-x-3">
                      <div
                        class="w-10 h-10 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center text-white font-bold text-sm hover:scale-105 transition-transform duration-200">
                  ...
                  <td class="px-6 py-4">
                    @if((int) $g->status === 1)
                      <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-emerald-200 text-emerald-900 badge-glow hover:shadow-md hover:bg-emerald-300 transition-all duration-200">
                        <span class="w-2 h-2 bg-emerald-500 rounded-full mr-2"></span> Xuất bản
                      </span>
                    @else
                      <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-slate-200 text-slate-900 badge-glow hover:shadow-md hover:bg-slate-300 transition-all duration-200">
                  ...
                  <td class="px-6 py-4 text-right">
                    <div class="flex items-center justify-end space-x-2">
                      ...
                      <form action="{{ route('admin.guides.togglePublish', $g->guide_id) }}" method="POST" class="inline">
                        ...
                        @method('PATCH')
                        <button
                          class="inline-flex items-center px-3 py-2 bg-indigo-100 text-indigo-800 rounded-lg hover:bg-indigo-200 hover:scale-105 transition-all duration-200 text-sm font-medium">
