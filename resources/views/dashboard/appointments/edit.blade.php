    ...
    <style>
        * {
        ...
        .field input[type="time"] {
            padding-left: 2.5rem;
            /* tăng padding để chữ không dính icon */
            height: 42px;
        }
    ...
    <div class="container fade-in">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('admin.appointments.update', $appointment->appointment_id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <input type="date" name="appointment_date" id="appointment_date"
                                    ...
                                    value="{{ $apptDate }}" min="{{ now()->toDateString() }}" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <input type="time" name="start_time" id="start_time"
                                    class="form-control @error('start_time') is-invalid @enderror" value="{{ $startTime }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <input type="time" name="end_time" id="end_time"
                                    class="form-control @error('end_time') is-invalid @enderror" value="{{ $endTime }}"
                                    step="300" required>
                            </div>
                ...
                <div class="form-group"> <label for="status">Trạng thái <span style="color: #1d4ed8;">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" rows="4"
                        placeholder="Nhập ghi chú (nếu có)">{{ old('notes', $appointment->notes) }}</textarea>
                    @error('notes')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
