    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-number">
                {{ $appointments->where('appointment_date', '>=', now()->startOfMonth())->count() }}
            </div>
            ...
            <table class="modern-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                {{ $appointment->appointment_date?->timezone('Asia/Ho_Chi_Minh')->format('d/m/Y H:i:s') }}
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <form class="delete-form"
                                    action="{{ route('admin.appointments.destroy', $appointment->appointment_id) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="empty-state">
                                ...
                                <p class="empty-description">Hệ thống chưa có dữ liệu để hiển thị</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="{{ $appointments->previousPageUrl() ?? '#' }}"
                            class="px-3 py-2 text-sm font-medium bg-white border border-gray-300 rounded-lg 
