        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-2" style="font-size: 2.5rem; font-weight: 700;">
                    <i class="fas fa-plus-circle mr-3"></i>Thêm sản phẩm mới
                </h1>
    ...
    <div class="form-container">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
            ...
            <div class="form-card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <select name="status" class="form-control form-control-modern @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="2" {{ old('status') == 2 ? 'selected' : '' }}>Ngưng bán</option>
                                    <option value="3" {{ old('status') == 3 ? 'selected' : '' }}>Hết hàng</option>
                                </select>
                            </div>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-area" onclick="document.getElementById('images').click()">
                                <div id="uploadContent">
                                    ...
                                    <p class="mb-1" style="color: #1e40af; font-weight: 600;">Nhấp để chọn hình ảnh</p>
                                ...
                                <div id="imagePreview" style="display: none;">
                                    ...
                                    <p class="mt-2 mb-0 text-success font-weight-bold">
                                        <i class="fas fa-check-circle mr-1"></i>Hình ảnh đã chọn
                                    </p>
                                </div>
                            </div>
                            <input type="file" 
                ...
                <div class="form-group">
                    <label class="form-label">
                        <i class="fas fa-images mr-1"></i>Ảnh phụ sản phẩm
                    </label>
