...
@section('content')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="text-center">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="file" class="form-control-modern mt-2 w-full" id="avatar" name="avatar"
                                        accept="image/*">
                            ...
                            <div class="md:col-span-2 space-y-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" name="name" value="{{ old('name', $u?->name) }}" required>
                                    @error('name')
                                        <span class="text-sm text-red-600 mt-1" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control-modern w-full bg-gray-100 cursor-not-allowed"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="phone" name="phone" value="{{ old('phone', $u?->phone) }}">
                                    @error('phone')
                                        <span class="text-sm text-red-600 mt-1" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control-modern w-full @error('address') ring-2 ring-red-500 @enderror"
    ...
    document.getElementById('avatar').addEventListener('change', function (event) {
        ...
        preview.src = URL.createObjectURL(file); // preview ảnh mới
