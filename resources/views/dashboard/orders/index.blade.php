...
<style>
  ...
  .badge-pending{color:cornflowerblue}
...
<div class="container-fluid">
  ...
  <form method="get" class="d-flex flex-wrap gap-3 align-items-center bg-white rounded-xl shadow-lg px-4 py-3 border border-blue-100 mb-4">
    ...
    <select name="status"
            class="px-5 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ml-2">
    ...
    <input type="date" name="date_from" value="{{ request('date_from') }}"
           class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ml-2">
    <input type="date" name="date_to" value="{{ request('date_to') }}"
           class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ml-2">

    <button class="px-5 py-2 bg-blue-50 text-blue-600 font-medium rounded-lg hover:bg-blue-100 ml-2">
     
      <i class="fas fa-filter me-2"></i>Lọc
    </button>

    <a href="{{ route('admin.orders.index') }}"
       class="px-5 py-2 bg-gray-50 text-gray-700 font-medium rounded-lg hover:bg-gray-100 ml-2">
      Xoá lọc
    </a>
  </form>
