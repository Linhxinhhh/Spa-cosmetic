...
<head>
  ...
  <title>Đăng ký - AMU Beauty & Spa</title>
  <style>
    :root {
      --primary: #e8b4b8;
      --primary-dark: #d1969b;
  ...
  <div class="auth-card">
    <div class="auth-left">
      ...
      <div class="hero-copy">
        ...
        <p>Mỹ phẩm cao cấp và dịch vụ spa chất lượng hàng đầu </p>
        <div class="dots">
    ...
    <div class="auth-right">
      <h1 style="text-align: center" class="title">ĐĂNG KÝ</h1>
      ...
      <form class="form" method="POST" action="{{ route('users.register.post') }}" novalidate>
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" required placeholder="Nhập họ và tên" />
            @error('name')<small class="field-error">{{ $message }}</small>@enderror
          </div>
          <div class="form-group">
            <label for="email">Địa chỉ email</label>
            <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Nhập email" />
            @error('email')<small class="field-error">{{ $message }}</small>@enderror
          </div>
          <div class="form-group">
            <label for="password">Mật khẩu</label>
            <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Tạo mật khẩu" />
          ...
          <div class="form-group">
            ...
            <button type="button" class="toggle" data-toggle="#password_confirmation">👁</button>
          </div>
        </div>

        <label class="checkbox">
          <input type="checkbox" required />
          <span>Tôi đồng ý với<a href="#">Điều khoản và điều kiện</a> của <a href="#">Lyn Cosmetic & Spa</a></span>
        </label>
